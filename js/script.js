...
function checkReloadPage(){
    ...
    if (pickAnother == "n") {
        ...
        document.body.innerHTML = "<h1 style='margin: 1rem'>Goodbye!</h1><p>Thank you for playing some of the games I made! Please come back again soon</p><footer style='text-align: center; font-family: Arial, sans-serif;'>Please press F5 to reload the page</footer>";
    }
}